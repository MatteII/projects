...
const copyPassword = () => {
        ...
        copyIcon.innerHTML = "<i class=\"fa-solid fa-check\" style=\"font-size: 23px;\"></i>"; // changing copy icon to tick
        copyIcon.style.color = "#39f";
        setTimeout(() => { // after 1500 ms, changing tick icon back to copy
            copyIcon.innerHTML = "<i class=\"fa-regular fa-copy\" style=\"font-size: 23px;\"></i>";
            copyIcon.style.color = "#ececec";
        }, 1500);
    }
