...
class View {
    ...
    printImpossibleWallMessage() {
        ...
        box.innerHTML = "Deve rimanere almeno un passaggio libero!";
    ...
    render() {
        ...
        if (this.game.winner !== null) {
            if (this.game.winner.isHumanPlayer) {
                this.printGameResultMessage("Hai vinto contro l'IA di livello:  " + this.aiLevel+"!");
                this.printMessage("Hai vinto!");
            } else {
                this.printGameResultMessage("L'IA di livello "+this.aiLevel + " ha vinto...");
                this.printMessage("L'IA di livello "+this.aiLevel + " ha vinto...");
            }
        } else {
            if (this.game.pawnOfTurn.isHumanPlayer) {
                this._renderValidNextPawnPositions();
                this._renderValidNextWalls();
                this.printMessage("Il tuo turno.");
            } else {
                this.printMessage( "Turno dell'IA.");
            }
